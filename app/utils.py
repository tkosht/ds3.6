...
def plot_verif_component(verif, component="rain", year=2017):
   ...
   Parameters
    ...
    ax.fill_between(
        train.index,
        train.loc[:, component + "_lower"] * 100,
        train.loc[:, component + "_upper"] * 100,
        color="0.8",
        alpha=0.3,
    )
    ...
    ax.fill_between(
        test.index,
        test.loc[:, component + "_lower"] * 100,
        test.loc[:, component + "_upper"] * 100,
        color="0.8",
        alpha=0.3,
    )
...
def plot_joint_plot(
    verif, x="yhat", y="y", title=None, fpath="../figures/paper", fname=None
):
    """
